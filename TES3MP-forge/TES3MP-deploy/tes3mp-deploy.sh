...
Options:
  ...
  --repo [REPO]                  Specify TES3MP Repo - useful for building forks (e.g. https://PERSONAL_ACCESS_TOKEN@github.com/user/tes3mp.git)
...
press ENTER to continue"
  ...
  echo -e "\n>> Downloading software"
   ! [ -e "$CODE" ] && git clone -b "${TARGET_COMMIT:-master}" "${TES3MP_REPO}" "$CODE"
